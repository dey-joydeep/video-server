 ...
 * The logger outputs to console and a daily rotating file.
 * @param {object} options - Options for logger creation.
 * @param {string} options.dirname - The directory where log files will be stored.
 * @param {string} options.filename - The base filename for the log files (e.g., 'app_%DATE%.log').
